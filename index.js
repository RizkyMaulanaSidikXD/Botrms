...
//
const BotName = 'BOT ITSMEIKYXSEC404'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/itsmeikyxsec404/'; // Nama Instagramlu cok
const whatsapplu = '0812-8187-2699'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam Sayant'; // Kapan bot lu aktif
const grupch1 = 'https://youtube.com/ITSMEIKY'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://youtube.com/ITSMEIKY'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
